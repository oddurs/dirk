...
`##########` 100% · 8 of 8 done · due 2027-04-30
...
- [x] `0129` Reading a full-screen agent's history <sup>feature · p2 · agents</sup>
- [x] `0130` Telling dirk what is behind the wrapper <sup>feature · p2 · agents</sup>
- [x] `0131` Display tokens an outside program can set <sup>feature · p2 · agents</sup>
...
- [x] `0183` Every enum setting is a string, checked twice <sup>chore · p3 · config</sup>
...
- [x] `0187` Pick the pedantic lints worth keeping <sup>chore · p3 · packaging</sup>
- [x] `0189` NEWS stops four milestones ago <sup>docs · p1 · docs</sup>
- [x] `0191` A conflict marker can be committed and shipped <sup>bug · p2 · packaging</sup>
